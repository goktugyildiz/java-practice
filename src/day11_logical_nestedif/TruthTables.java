...
public class TruthTables {
	...
	public static void main(String[] args) {
		...
		System.out.println("When true and false - result is "+(true&&false));
		System.out.println("When false and true - result is "+(false&&true));
		System.out.println("When false and false - result is "+(false&&false));
		...
		System.out.println("Whem !true- result is " + (!true));
		System.out.println("Whem !false- result is " + (!false));
